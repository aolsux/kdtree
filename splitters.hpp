...
// NOTE i "stole" this file from the CGAL library, it will require heavy refactoring to match own needs, but should provide the basic ideas for diffrent splitting rules
  ...
  public:
    Splitter_base(unsigned int bucket_size = 3,  FT aspect_ratio = FT(3))       : the_bucket_size(bucket_size),    the_aspect_ratio(aspect_ratio)    {}

    FT  aspect_ratio() const  {      return the_aspect_ratio;    }
